...
class Paths
{
	...
	static public function getFolderDirectories(key:String, addPath:Bool = false,
			source:codename.backend.assets.AssetsLibraryList.AssetSource = BOTH):Array<String>
	{
		if (!key.endsWith("/"))
			key += "/";
	...
	static public function getFolderContent(key:String, addPath:Bool = false, source:codename.backend.assets.AssetsLibraryList.AssetSource = BOTH):Array<String>
	{
	...
	inline static public function configxml(key:String, ?library:String)
	{
