...
class ModsFolderLibrary extends AssetLibrary implements IModsAssetLibrary {
	...
	private function getAssetPath():String return '';

	private function __isCacheValid(cache:Map<String, Dynamic>, asset:String, isLocal:Bool = false):Bool return false;

	private function __parseAsset(asset:String):Bool return false;

	public function getFiles(folder:String):Array<String> return [];

	public function getFolders(folder:String):Array<String> return [];
	#end
}