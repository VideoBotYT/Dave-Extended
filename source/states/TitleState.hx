...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		logoBl = new FlxSprite(titleJSON.titlex, titleJSON.titley+50).loadGraphic(Paths.image("notitg/title"));
		...
		pressEnter = new FlxText(0, titleJSON.starty, 300, "PRESS ENTER", 32);
