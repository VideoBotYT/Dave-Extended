...
class PlayState extends MusicBeatState
{
	...
	public var camPlay:FlxCamera;
	public var camManager:FlxCamera;
	...
	override public function create()
	{
		...
		camPlay = new FlxCamera();
		camPlay.bgColor.alpha = 0;

		camManager = new FlxCamera();
		camManager.bgColor.alpha = 0;

		FlxG.cameras.add(camManager, false);
		FlxG.cameras.add(camHUD, false);
		FlxG.cameras.add(camOther, false);
		FlxG.cameras.add(camPlay, false);
	...
	{
		healthBar.setColors(0x00000000, FlxColor.fromRGB(255, 255, 255));
	}
